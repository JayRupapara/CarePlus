                ...
                <section class=" body-font">
                    <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
                        <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
                            <img src={PatientImg} width={500} alt="" />
                        ...
                        <div class="lg:w-2/6 md:w-1/2  rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                            <h2 class="text-primary font-semibold text-2xl title-font mb-5">Patient Sign In</h2>
                            ...
                            <p class="mt-3">Don't Have an Account?<Link to={"/register-patient"} className='text-primary'> Register Now</Link></p>
                        </div>
                    </div>
                </section>
            </div>
