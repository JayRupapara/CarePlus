...
import L2 from "../assets/L22.jpg"; // Import L2.jpeg (local image)
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="flex-grow">
        <section className="flex flex-col items-center justify-center bg-custom-bg pt-20 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between w-full max-w-7xl md:flex-row">
            <div className="w-full md:w-8/12 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-secondary pb-6 md:pb-10">
                Revolutionise Your <br /> Hospital Management <br /> By just a QR
              </h1>
              <p className="text-lg md:text-xl pb-6 md:pb-8 text-secondary">
                Care+ Streamline operations, enhance patient care, and optimize
                resource allocation with our cutting-edge platform.
              </p>
              <button className="rounded-2xl bg-primary px-6 py-3 mb-6 md:mb-10 text-white w-fit">
                Make Appointment
              </button>
            </div>
            <div className="w-full md:w-6/12 flex justify-center md:justify-end">
              <img src={L1} alt="QR Code" className="w-full max-w-xs md:max-w-lg" /> {/* Local L1 image */}
            </div>
          </div>
        </section>
        ...
        <section className="py-32">
          <div className="container mx-auto flex flex-col items-center justify-center space-y-8 px-4 sm:px-6 lg:px-8">
            {/* Heading */}
            <h2 className="text-3xl sm:text-4xl font-bold text-center text-secondary">
              Find the Best Healthcare Services Near You
            </h2>
            <p className="text-base sm:text-lg text-center text-gray-700 max-w-2xl sm:max-w-3xl">
              Use our search tool to locate the best hospitals and doctors in your area. Whether you’re looking for a specialist or general services, we can help you find what you need.
            </p>
            ...
            <div className="w-full max-w-4xl space-y-4 px-4">
              <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 justify-center">
                {/* City Dropdown */}
                <select className="w-full px-4 py-3 bg-white border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                ...
                {/* Search Button */}
                <button className="flex items-center justify-center rounded-2xl bg-primary px-6 py-2 text-white hover:bg-red-600">
        ...
        <section className="py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-center text-secondary">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              ...
              <div className="rounded-2xl bg-white p-6 md:p-8 text-center ">
                <AiOutlineSchedule className="mx-auto h-16 w-16 text-secondary mb-4" /> {/* Appointment Icon */}
              ...
              <div className="rounded-2xl bg-white p-6 md:p-8 text-center ">
                <FaRobot className="mx-auto h-16 w-16 text-secondary mb-4" /> {/* AI Assist Icon */}
                <h3 className="text-lg md:text-xl font-semibold text-secondary">
              ...
              <div className="rounded-2xl bg-white p-6 md:p-8 text-center ">
                <GiMedicines className="mx-auto h-16 w-16 text-secondary mb-4" /> {/* Pharmacy Icon */}
                <h3 className="text-lg md:text-xl font-semibold text-secondary">
                  Online Pharmacy
                </h3>
                <p className="mt-2 text-gray-600">
        ...
        <section className="py-32"> {/* Light red background */}
          <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 md:grid-cols-2">
            ...
            <div className="flex flex-wrap justify-around">
              {/* Card 1 */}
              <div className="rounded-2xl bg-white p-8 flex flex-col justify-center items-center text-center">
              ...
              <div className="rounded-2xl bg-white p-8 flex flex-col justify-center items-center text-center">
                <p className="mb-2 text-lg text-gray-600">Registered Patients</p>
                <p className="text-5xl font-bold text-primary">1k +</p>
              </div>
            </div>
          </div>
        </section>
