...
const Home = () => {
  ...
  <div className="flex flex-col items-center justify-between w-full max-w-7xl md:flex-row">
    <div className="w-full md:w-8/12 text-center md:text-left">
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-blue-900 pb-6 md:pb-10">
        Revolutionise Your <br /> Hospital Management <br /> By just a QR
      </h1>
      <p className="text-lg md:text-xl pb-6 md:pb-8 text-blue-900">
  ...
  <div className="container mx-auto flex flex-col items-center justify-center space-y-8 px-4 sm:px-6 lg:px-8">
    ...
    <div className="w-full max-w-4xl space-y-4 px-4">
      <div className="flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-4 justify-center">
        {/* City Dropdown */}
        <select className="w-full md:w-1/3 rounded-2xl border px-4 py-2 focus:border-blue-300 focus:outline-none focus:ring">
        ...
        {/* Search Button */}
        <button className="flex items-center justify-center rounded-2xl bg-primary px-4 py-2 text-white hover:bg-red-600">
...
<section className="py-16">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
      ...
      <div className="rounded-2xl bg-white p-6 md:p-8 text-center shadow-md">
        <AiOutlineSchedule className="mx-auto h-16 w-16 text-blue-900 mb-4" /> {/* Appointment Icon */}
      ...
      <div className="rounded-2xl bg-white p-6 md:p-8 text-center shadow-md">
        <FaRobot className="mx-auto h-16 w-16 text-blue-900 mb-4" /> {/* AI Assist Icon */}
        <h3 className="text-lg md:text-xl font-semibold text-blue-900">
      ...
      <div className="rounded-2xl bg-white p-6 md:p-8 text-center shadow-md">
        <GiMedicines className="mx-auto h-16 w-16 text-blue-900 mb-4" /> {/* Pharmacy Icon */}
        <h3 className="text-lg md:text-xl font-semibold text-blue-900">
          Online Pharmacy
        </h3>
        <p className="mt-2 text-gray-600">
